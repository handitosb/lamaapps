...
import 'package:lama_app/app/screens/flutters_game_screen.dart';
import 'package:lama_app/app/screens/happybird_game_screen.dart';
...
void _navigateToGame(String gameName, BuildContext context,
  ...
  switch (gameName) {
    ...
    case "Affen-Leiter":
      ...
      break;
    case "Flybird":
      gameToLaunch = FluttersGameScreen(userRepository);
      break;
    case "HappyBird":
      gameToLaunch = HappyBirdGameScreen(userRepository);
      break;
    default:
