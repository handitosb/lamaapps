...
import 'package:lama_app/app/screens/task_type_screens/bild_card_task_screen.dart';
import 'package:lama_app/app/screens/task_type_screens/bild_four_card_task_screen.dart';
...
class TaskScreenState extends State<TaskScreen> {
  ...
  Widget getScreenForTaskWithConstraints(
    ...
    switch (task.type) {
      ...
      case "BildCard":
        return BildCardTaskScreen(task, constraints);
      case "MarkWords":
